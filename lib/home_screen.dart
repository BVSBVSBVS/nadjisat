...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final Map<String, List<String>> brendoviIModeli = {
    'Svi': [],
    'A. Lange & Söhne': ['1815', 'Datograph', 'Lange 1', 'Zeitwerk'],
    ...
    'IWC Schaffhausen': ['Portugieser', 'Big Pilot', 'Portofino'],
    'Omega': ['Speedmaster', 'Seamaster', 'Constellation', 'Aqua Terra'],
    'Patek Philippe': ['Nautilus', 'Calatrava', 'Aquanaut'],
    'Rolex': ['Submariner', 'Daytona', 'Datejust', 'GMT-Master II', 'Explorer', 'Day-Date'],
  ...
  final List<String> mehanizmi = ['Sve', 'Automatik', 'Manuelni', 'Kvarcni', 'Spring Drive', 'Solar'];
  final List<String> precnici = ['Sve', ...List.generate(41, (index) => "${20 + index}mm")];
  final List<String> materijali = ['Sve', 'Čelik', 'Zlato (18k)', 'Titanijum', 'Platina', 'Keramika', 'Bronza'];
  final List<String> materijaliNarukvice = ['Sve', 'Čelik', 'Koža', 'Guma', 'Tekstil/Nato', 'Titanijum'];
  final List<String> bojeBrojcanika = ['Sve', 'Crna', 'Plava', 'Bela/Srebrna', 'Zelena', 'Zlatna'];
  ...
  Widget build(BuildContext context) {
    ...
    int brojKolona = screenWidth > 1200 ? 6 : (screenWidth > 900 ? 4 : (screenWidth > 600 ? 3 : 2));
            ...
            child: StreamBuilder<List<Map<String, dynamic>>>(
              ...
              builder: (context, snapshot) {
                ...
                return GridView.builder(
                  ...
                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: brojKolona, crossAxisSpacing: 12, mainAxisSpacing: 12, childAspectRatio: 0.72),
                    ...
                    return FutureBuilder<Map<String, dynamic>?>(
                      ...
                      builder: (context, profSnapshot) {
                        ...
                        if (jePartner) {
                          ...
                          okvirBoja = Colors.orange;
                          bedzBoja = Colors.orange;
                          bedzTekst = "FIRMA";
                        } else if (jeVerifikovan) {
                          okvirBoja = Colors.green;
                          bedzBoja = Colors.green;
                          bedzTekst = "VERIFIKOVAN";
                        }

                        return GestureDetector(
                          onTap: () { Navigator.push(context, MaterialPageRoute(builder: (context) => OglasDetaljiScreen(oglas: sat))); },
                          child: Container(
                                ...
                                if (bedzTekst != null)
                                  Positioned(
                                    ...
                                    child: Container(
                                      ...
                                      child: Text(bedzTekst, style: const TextStyle(color: Colors.white, fontSize: 10, fontWeight: FontWeight.bold, letterSpacing: 1.0)),
                                    ),
                                  )
                              ],
                            ),
